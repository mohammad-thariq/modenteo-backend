...
export const getUserByUserType = (type, callBack) => {
  db.query(`SELECT id, first_name, last_name, email, type FROM users WHERE type = ?`, [type], (error, results) => {
    if (error) {
      return callBack(error);
    }
    return callBack(null, results);
...
export const getOrderCount = (id, callBack) => {
  db.query(`SELECT COUNT(*) as order_count FROM orders WHERE user_id = ?`, [id], (error, results) => {
    if (error) {
      return callBack(error);
    }
    return callBack(null, results);
...
export const getCartCount = (id, callBack) => {
  db.query(`SELECT COUNT(*) as cart_count FROM cart WHERE user_id = ?`, [id], (error, results) => {
    if (error) {
      return callBack(error);
    }
    return callBack(null, results);
...
export const getWishlistCount = (id, callBack) => {
  db.query(`SELECT COUNT(*) as wishlist_count FROM wishlist WHERE user_id = ?`, [id], (error, results) => {
    if (error) {
      return callBack(error);
    }
    return callBack(null, results);
